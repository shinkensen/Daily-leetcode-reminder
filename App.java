...
public class App {
    ...
    public static void main(String[] args) {
        ...
        final String fromEmail = "noobywinner58@gmail.com";
        final String password = "enel yihg nvgs zhms"; // Use App Password, not your main password
        final String toEmail = "noobywinner587@gmail.com";
        final String toEmail_two = "pratheeshstkt@gmail.com";
